...
#define LIGHT_GREY_COLOR 0xC618
#define SEA_GREEN_COLOR 0x4574

#define COLOR_BACKGROUND BLACK_COLOR
#define COLOR_PRIMARY LIGHT_GREY_COLOR
#define COLOR_SECONDARY SEA_GREEN_COLOR
#define COLOR_SUCCESS GREEN_COLOR
